...
export const projects: Project[] = [
  ...
  },
  {
    ...
    initials: "PV",
    domain: "reshaananda-portfolio.vercel.app",
    year: "2026",
    category: { en: "Web App", id: "Aplikasi Web" },
    date: { en: "August 2026", id: "Agustus 2026" },
    summary: {
    ...
    challenges: {
      en: [
        ...
        "Keeping every page accessible, fast, and free of console errors across light/dark and EN/ID.",
      ],
      id: [
        "Memilih struktur proyek yang tetap rapi seiring bertambahnya fitur.",
        "Menjaga setiap halaman tetap aksesibel, cepat, dan bebas error konsol di mode terang/gelap serta EN/ID.",
      ],
    },
    outcome: {
